...
heat_demand_scen = ["./Database/Heat_demand/CY/Vassilikos_CCP2.csv", "./Database/Heat_demand/CY/Vassilikos_CCP2.csv_80"]

power_scen = ["./Database/PowerPlants/##/2015.csv", "./Database/PowerPlants/##/2015_heat.csv"]
