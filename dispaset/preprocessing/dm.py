...
class DispaModel(object):
    ...
    def __init__(self, config): # TODO constructor
        ...
        self.SimData = {'sets': sets, 'parameters': parameters, 'config': self.config, 'units': self.data.Plants_merged, 'version': dispa_version}
...
class DataLoader(object):
    def __init__(self, config):
        ...
        # adding cep
        if config['CEP'] == 1:
            self.df_expanded = load_cep_parameters(config, self.Plants_merged)
