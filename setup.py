...
setup(
    ...
    entry_points={"console_scripts": ["dispaset = DispaSET.cli:cli"]},
    classifiers=["Intended Audience :: Science/Research", "License :: OSI Approved :: EUPL Software License", "Programming Language :: Python"],
